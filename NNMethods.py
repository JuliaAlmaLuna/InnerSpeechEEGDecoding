...
def useBestModel(
    dataT, reg1=3, reg2=3, reg3=3, dropout=1, layerSize=50, activation="relu"
):
...
def trainTestModel2(
    ...
    plt.title(
        "Training and validation loss for reg val {} and dropout val {} and layersize val {}".format(
            reg, drp, lz
        )
    )
    plt.legend()
    ...
    plt.title(
        "Training and validation acc for reg val {} and dropout val {} and layersize val {}".format(
            reg, drp, lz
        )
    )
    plt.legend()
