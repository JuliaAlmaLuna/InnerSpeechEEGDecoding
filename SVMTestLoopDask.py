...
def daskTest(fClass, fmet, seed, sub):
    ...
    for data_train, data_test, labels_train, labels_test , name in mDataList:
        ...
        bestLin, bestRBF, bestSigm, allResults = fmet.testSuite(data_train, data_test, labels_train, labels_test, name)
...
for seed in np.arange(1818,1820):
    ...
    #for sub in [1]:
        ...
        resultDoneList.append(daskTest(fClassDict[f"{seed},{sub}"], fmetDict[f"{seed},{sub}"], seed, sub))
