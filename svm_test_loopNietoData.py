...
def main():
    ...
    signAll = True  # Using mask created from other subjects
...
def winFeatFunction(featureList, subjects, paradigm, globalSignificanceThreshold,
                    ...
                    soloSignificanceThreshold, signAll, signSolo,
                    tolerance, quickTest, baselineF=False, holdOut=False, myOwnTest=False):
    print(f"FeatureList so far: {featureList}")
    # Creating the features for each subject and putting them in a dict
    fClassDict2 = dict()
    fmetDict2 = dict()
